...
start_date = "2021-12-21T00:00" # define el periodo inicial formato YYYY:MM:DDTHH:MM
end_date = "2021-12-21T14:00" # define el periodo final formato YYYY:MM:DDTHH:MM
